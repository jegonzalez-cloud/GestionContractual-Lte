...
function Millones(num: any) {
  ...
  let strMillones = Seccion(num, divisor, 'UN MILLON DE', 'MILLONES');//MILLONES DE
...
export function NumeroALetras(num: any) {
  let data: any = {
    numero: num,
    enteros: Math.floor(num),
    centavos: (((Math.round(num * 100)) - (Math.floor(num) * 100))),
    letrasCentavos: '',
    letrasMonedaPlural: 'PESOS',//'PESOS', 'Dólares', 'Bolívares', 'etcs','Córdobas'
    letrasMonedaSingular: 'PESO', //'PESO', 'Dólar', 'Bolivar', 'etc','Córdoba'
